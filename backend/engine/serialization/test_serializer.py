...
class SerializerTest(unittest.TestCase):
    ...
    def check_pdf_serialization(self, fourcc:str,out_format:str,block_size:int):
        ...
        # obfuscated_vid_path, zipped_file_size='C:/ComputerScience/Workshop/UsedTube/backend/engine/artifacts/test_output_files/output-video_vp09.mp4',12233262
        ...
        print(obfuscated_vid_path)
        deserialized_pdf_file = open(deserialized_pdf_path, "wb+")
    ...
    def perform_test_1Bit_Block(self, codec, file_ext):
        ...
        sha256_1, sha256_2 = self.check_pdf_serialization(fourcc=codec, out_format=file_ext, block_size=4)
