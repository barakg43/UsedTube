...
class Driver:
    ...
    def process_file_to_video(self, file_path: str) -> Tuple[str, int]:
        # zip
    ...
    def process_video_to_file(self, video_path: str, compressed_file_size: int) -> str:
        # untangle
        serialized_file_as_video_path = self.__obfuscator.untangle(video_path)
        # deserialize
        zipped_file_path = self.__serializer.deserialize(serialized_file_as_video_path, compressed_file_size)
        # unzip
