# Generated by Django 4.1.13 on 2024-08-02 11:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_item',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='shared_files',
                                   to='files.file')),
                ('folder_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='shared_folders', to=settings.AUTH_USER_MODEL)),
                ('shared_with',
